...
export const metadata = {
  title: 'ویزای توریستی روسیه برای ایرانیان | شرایط و مدارک ۲۰۲۶',
  description: 'ویزای توریستی روسیه از ایروان: eVisa در ۴ روز کاری (تا ۳۰ روز اقامت) یا ویزای سفارت تا ۳۰ روز اقامت. مدارک، دعوتنامه رسمی و مراحل کامل درخواست.',
  ...
  openGraph: {
    title: 'ویزای توریستی روسیه برای ایرانیان | شرایط و مدارک',
    description: 'eVisa در ۴ روز کاری، یا ویزای سفارت — هر دو تا ۳۰ روز اقامت. راهنمای کامل و دعوتنامه رسمی.',
