...
const FESTIVAL_DATA = [
  ...
  { id: 'color-fest', month: 6, star: 4, nameFa: 'جشنواره رنگ ایروان', nameEn: 'Yerevan Color Festival', date: 'معمولاً ژوئن یا ژوئیه (متغیر)', location: 'فضای باز، نقاط مختلف ایروان', desc: 'یک مسیر دویدن معمولاً ۵ کیلومتری در فضای باز که شرکت‌کنندگان در طول مسیر و در پایان آن با پودرهای رنگی گیاهی و بی‌خطر غرق می‌شوند. برنامه با موسیقی زنده دی‌جی‌ها، رقص و پایکوبی گروهی همراه است. چون تاریخ دقیق هرسال ممکنه توسط برگزارکنندگان محلی تغییر کنه، نزدیک تابستان تاریخ نهایی رو از ما بگیرید.', image: null },
